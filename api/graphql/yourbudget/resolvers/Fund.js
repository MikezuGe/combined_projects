...
const Mutations = {
  ...
  updateFunds: async args => await Fund.findOneAndUpdate({ _id: args.input.id, }, (delete args.input.id && args.input), { new: true, }),
  removeFunds: async args => await Fund.deleteOne({ _id: args.id, }),
};
