...
var Game = function () {
  ...
  _createClass(Game, [{
    key: 'updatePlayersNext',
    value: function updatePlayersNext(players) {
    ...
    key: 'updatePlayersCurrent',
    value: function updatePlayersCurrent() {
    ...
    value: function playersRender() {
      var nonNullPlayers = this.playersCurrent.filter(function (player) {
        return player !== null;
      });
...
var Input = function () {
  ...
  _createClass(Input, [{
    ...
    value: function clear() {
      ...
      btns.forEach(function (btn) {
        if (!_this2[btn].pressed) {
          _this2[btn].drag = false;
          _this2[btn].startX = null;
          _this2[btn].startY = null;
          _this2[btn].endX = null;
          _this2[btn].endY = null;
          _this2[btn].minX = null;
          _this2[btn].minY = null;
          _this2[btn].maxX = null;
          _this2[btn].maxY = null;
        }
      });
      this.mouseDeltaX = 0;
      this.mouseDeltaY = 0;
...
_event.windowMouseDownEvent.subscribe(input.handleMouseDown);
_event.windowMouseUpEvent.subscribe(input.handleMouseUp);
_event.windowMouseMoveEvent.subscribe(input.handleMouseMove);
_event.windowWheelEvent.subscribe(input.handleMouseWheel);
_event.windowKeyDownEvent.subscribe(input.handleKeyDown);
_event.windowKeyUpEvent.subscribe(input.handleKeyUp);
...
var Me = function () {
  ...
  _createClass(Me, [{
    key: 'outsideofScreen',
    value: function outsideofScreen(width, height) {
      var x = this.x,
          y = this.y,
          r = this.r;
    ...
    key: 'update',
    value: function update() {
      var keys = _input2.default.keys;
      var deltaTime = _time2.default.deltaTime;
      ...
      if (this.velocity !== 0) {
        this.direction += this.velocity > 0 ? this.turnVelocity : -this.turnVelocity;
      } else {
        this.turnVelocity = 0;
      }
    ...
    value: function render() {
      ...
      if (this.outsideofScreen(width, height)) {
        ...
        var dirX = this.x - middleX;
        var dirY = this.y - middleY;
