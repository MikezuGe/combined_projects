...
var _ctx = __webpack_require__(/*! ./ctx */ "./public/snd/src/ctx.js");

__webpack_require__(/*! ./login */ "./public/snd/src/login.js");

__webpack_require__(/*! ./style.css */ "./public/snd/src/style.css");

/***/ }),

/***/ "./public/snd/src/ctx.js":
/*!*******************************!*\
  !*** ./public/snd/src/ctx.js ***!
  \*******************************/
/*! no static exports found */
...
var _events = __webpack_require__(/*! ./events */ "./public/snd/src/events.js");
...
_events2.default.subscribeTo('windowResize', canvas.resize);
...
var Events = function () {
  ...
  _createClass(Events, [{
    key: 'addEvent',
    value: function addEvent(name, event) {
    ...
    key: 'subscribeTo',
    value: function subscribeTo(name) {
      var event = this.events.get(name);
      if (!event) {
        throw new Error('Can\'t subscribe to event, no such event: ' + name);
      }

      for (var _len = arguments.length, subscribers = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        subscribers[_key - 1] = arguments[_key];
      }
    ...
    key: 'unSubscribeFrom',
    value: function unSubscribeFrom(name) {
      var event = this.events.get(name);
      if (!event) {
        throw new Error('Can\'t unsubscribe from event, no such event: ' + name);
      }

      for (var _len2 = arguments.length, subscribers = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
        subscribers[_key2 - 1] = arguments[_key2];
      }
    ...
    key: 'startEvent',
    value: function startEvent(name) {
      var event = this.events.get(name);
      if (!event) {
...
var Event = function () {
  ...
  _createClass(Event, [{
    key: 'createInvoker',
    value: function createInvoker(preventDefault, stopPropagation) {
      var _this = this;
...
var _notice = __webpack_require__(/*! ./notice */ "./public/snd/src/notice.js");

var _notice2 = _interopRequireDefault(_notice);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_axios2.default.defaults.baseURL = window.location.origin + '/api/snd';
...
function login(e) {
  ...
  _axios2.default.post('/login', inputValues).then(function (response) {
    var result = response.data;
    (0, _notice2.default)(result.status);
    console.log(result);
  }).catch(function (err) {
    (0, _notice2.default)('Login failed');
  });
}
...
function createAccount(e) {
  ...
  _axios2.default.post('/user', inputValues).then(function (response) {
    var result = response.data;
    ...
    try {
      for (var _iterator3 = form[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var _input = _step3.value;

        var inputResult = result[_input.name];
        if (inputResult.result < 1) {
          _input.nextSibling.textContent = inputResult.status;
        }
      }
    } catch (err) {
    ...
    (0, _notice2.default)('Creating account failed');
  });
}

/***/ }),

/***/ "./public/snd/src/notice.js":
/*!**********************************!*\
  !*** ./public/snd/src/notice.js ***!
  \**********************************/
/*! no static exports found */
...
exports.default = addNotice;
var noticeContainer = document.getElementById('notice_container');

function addNotice(msg) {
  var _ref = [document.createElement('div'), document.createElement('div')],
      notice = _ref[0],
      noticeMessage = _ref[1];
